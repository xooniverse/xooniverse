...
if( ! empty( $_POST['email'] ) ) {
	...
	$receiver_email = 'hello@xooniverse.com';
	...
	if( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
		...
		$message = '<html>
			...
			<body>
				...
				<tr>
				<td colspan="2" align="center" valign="top"><img style="margin-top: 15px;" src="http://www.xooniverse.com/images/logo-email.png" ></td>
				</tr>
				<tr>
